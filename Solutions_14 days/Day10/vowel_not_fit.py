...
def solve(arr):
    ...
    for ele in arr:
        ...
        if n > 2:
            ...
            if all_vowels(middle) and no_vowels(first) and no_vowels(last):
                ans.append(ele)
    return ans

def main():
    
    sub1 = all_sub_strings("bacdagh")
    sub2 = all_sub_strings("abcedf")
    sub3 = all_sub_strings("zwnaxzw")
    sub4 = all_sub_strings("mprofghiz")
